...
EXPOSE 8080
ENTRYPOINT ["java","-Dspring.profiles.active=${PROFILE_ACTIVE}","-Djasypt.encryptor.password=${JASYPT_SECRET}","-Dspring.config.import=optional:configserver:https://dev.yeohaengparty.com/config", "-jar","app.jar"]